...
interface EditClientModalProps {
  isOpen: boolean
  onClose: () => void
  onEditClient: (clientId: string, clientData: Omit<Client, 'joinDate'>) => void
  client: Client | null
  clientId: string
}

export function EditClientModal({ isOpen, onClose, onEditClient, client, clientId }: EditClientModalProps) {
  ...
  // Pré-remplir le formulaire quand un client est sélectionné
  useEffect(() => {
    if (client && isOpen) {
      setFormData({
        name: client.name,
