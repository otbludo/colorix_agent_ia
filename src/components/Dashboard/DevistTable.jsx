...
import { CustomerFilterDropdown } from '../Customer/CustomerFilterDropdown'
...
export function DevistTable() {
  ...
  const handleEditClient = (clientId, clientData) => {
  ...
  const openDeleteModal = (client, clientId) => {
            ...
            >
              ...
              <td className="py-4 px-4">
                <CustomersActionsDropdown
                  onEdit={() => setFormCustomerModalOpen(true)}
